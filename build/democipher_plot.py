...
<body>
  <div class="wrap">
    <header style="margin: 24px 0 18px; text-align:center">
      ...
      <p class="text-sm mb-4">
        Below you will find the <b>interactive "Hospital at Ransom" cube</b>, which is a demo model bult from our CIPHER dataset, developed for a hypothetical hospital context.
      ...
      <p class="text-sm mb-4">
        <b>Click on each <u>data point</u> to view an <u>information pane</u> detailing the safety incident, and links to underlying source material</b> 
      </p>
    </header>
